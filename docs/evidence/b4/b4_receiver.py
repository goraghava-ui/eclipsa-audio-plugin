#!/usr/bin/env python3
"""B4 gate receiver — a real Studio-side BridgeLink, timestamping every message.
...
OUT = "/data/build/b4/received.json"
DONE = "/data/build/b4/harness-done"
TIMEOUT_S = float(os.environ.get("B4_TIMEOUT", "180"))
